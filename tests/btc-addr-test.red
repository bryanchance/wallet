...
===start-group=== "btc-addr"
	...
	--test-- "btc-addr ledger xkey first"
		--assert expected = btc-addr/pubkey-to-addr xkey 'TEST-P2SH
	...
	--test-- "btc-addr ledger ykey first"
		--assert expected = btc-addr/pubkey-to-addr xkey 'P2SH
	...
	--test-- "btc-addr ykey"
		--assert expected = btc-addr/pubkey-to-addr ykey 'TEST-P2SH
