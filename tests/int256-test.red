...
===start-group=== "modulo"
	...
	--test-- "modulo-1"
		...
		z: to-i256 #{04D65FCE011789A6FED8F04CFE278BCF7D542480C3670895DC4D94A98E1EE497}
		--assert z  = mod256 x  y
	--test-- "modulo-2"
...
===start-group=== "Divide"
	...
	--test-- "divide-1"
		x: to-i256 #{01}
		y: to-i256 #{00}
		--assert "zero-divide" = select try [ div256 x y ] 'arg2
	--test-- "divide-2"
		x: to-i256 #{00}
		y: to-i256 #{00}
		--assert "zero-divide" = select try [ div256 x y ] 'arg2
	...
	--test-- "divide-5"
		...
		z: to-i256 #{FFFFFFFFFFFFFFFFDB4C3DAF69079FB738E8B36E59059FD51B4E8A614EEC7751}
		--assert z  = div256 x  y
	--test-- "divide-6"
		x: to-i256 #{0582A65B75A4C270F2AE2CFDF618E345D3BDD6E2558D29A103D848AB78DA759A}
